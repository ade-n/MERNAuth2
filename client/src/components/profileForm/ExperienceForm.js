...
const ExperienceForm = ({ auth: { user }, addExperience }) => {
  ...
  const { title, company, description, from, current, to } = formData;
  ...
  return (
    <Fragment>
      <div className="px-12 md:py-24 py-16 w-full  flex items-center md:h-screen h-full bg-indigo-700 ">
        <div className="mx-auto md:w-1/2 w-full p-4">
          ...
          <form className="py-4  mx-auto" onSubmit={onSubmit}>
            <div className="pb-2">
              <label className="block py-2 text-white">Title</label>
              <input
                autoComplete="off"
            ...
            <div>
              <label className="block py-2 text-white">Company</label>
              <input
                className="w-full focus:outline-none px-4 py-3 bg-indigo-500"
                name="company"
                value={company}
                placeholder="AA Architects"
                type="text"
                onChange={onChange}
              />
            </div>
            ...
            <div>
              <label className="block py-2 text-white">Description</label>
              <textarea
                className="w-full focus:outline-none px-4 py-3 bg-indigo-500"
                name="description"
                value={description}
                placeholder="Describe your experience. Max 250 characters"
                type="text"
                onChange={onChange}
              />
            </div>
            ...
            <div>
              <label className="block py-2 text-white">
                Current Experience
              </label>
              <input
                type="checkbox"
